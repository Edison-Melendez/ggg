        ...
        items: [
          {
            ...
            { to: '/helloReact', label: 'Compatible Hardware', position: 'right' }, // New link
            { to: '/Journals', label: 'Journals', position: 'right' },
            
          
          {to: '/blog', label: 'Contributors', position: 'right'},
          {
